...
public class Main 
{
	...
	@SidedProxy(clientSide="com.jtrent238.furnituremod.client.ClientProxy", serverSide="com.jtrent238.furnituremod.common.CommonProxy")
	public static CommonProxy proxy;
	
	
	public static final String MODID = "furnituremod";

	@Instance(MODID)
    public static Main instance;
	public static final String MODVERSION = "1.0.0.0";
	public final static String COREVERSION = "1.0.0.3";
	public static final String MODNAME = "jtrent238's Furniture Mod";
...
public static CreativeTabs FurnitureTab = new CreativeTabs("FurnitureTab")

{
	public Item getTabIconItem() {

		return new ItemStack(BlockLoader.BlockChairChesterfield).getItem();
	}
